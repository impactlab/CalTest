*********************************************
*****Realized savings estimation for all*****
*****            EUC homes              *****
*****             Matt Gee              *****
*****            version 1.3            *****
*****            22, June 2014          *****
...
*check that degree-day files are correct and using CZ2010
...
*change project data dataset to include all projects. Key varibles are:
...
drop if site_number==11 |site_number==16|site_number==15
